# MACRO SNAPSHOT — 2026-07-17

## COT (as of 2026-07-07) — Leveraged Funds (TFF) / Managed Money (GOLD)

| Activ | Net | Δ 1w | % din OI | Percentilă 52w | Extremă |
|---|---|---|---|---|---|
| EUR | -45,461 | -12,817 | -5.7% | 2 | SHORT |
| GBP | +17,979 | +1,706 | 6.4% | 25 | — |
| CAD | -85,957 | +2,144 | -23.6% | 4 | SHORT |
| JPY | -90,083 | +25,317 | -22.6% | 12 | — |
| CHF | -7,218 | +2,448 | -6.7% | 13 | — |
| AUD | +29,683 | -2,094 | 14.5% | 46 | — |
| NZD | -27,201 | -1,916 | -24.0% | 4 | SHORT |
| DXY | -4,454 | +1,126 | -8.3% | 58 | — |
| GOLD | +116,161 | -3,930 | 31.2% | 56 | — |

## Randamente 2Y/10Y (Δ = ~5 ședințe)

| | 2Y | Δ2Y | 10Y | Δ10Y |
|---|---|---|---|---|
| US | 4.16 | +0.0 | 4.57 | +0.03 |
...
|---|---|---|---|---|
| EURUSD | -1.461 | +0.084 | -1.393 | +0.018 |
| GBPUSD | — | — | — | — |
| AUDUSD | 0.337 | +0.417 | 0.261 | +0.051 |
| NZDUSD | — | — | — | — |
| USDJPY | — | — | — | — |
| USDCHF | — | — | — | — |
| USDCAD | 1.33 | -0.03 | 1.04 | +0.02 |
