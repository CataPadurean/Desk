...
window.DESK_DATA = {
  ...
  summaries: [
    { k: "Central Banks", pg: "p1_central_banks.html", v: "Fed hold 3,50-3,75%, ton hawkish (dot 3,8% = un hike pe masă) vs. pricing dovish post-NFP — minute 8.07 arbitrează; RBNZ 8.07: HIKE la 2,50% devenit consens (22/28); ECB hold, HICP moale; BoE split 7-2, PMI 48,8; BoC hold — MPR 15.07 (Tier 1 CAD); BoJ 1,00% + încă un hike; RBA/SNB hold." },
    { k: "Bank Reports", pg: "p2_bank_reports.html", v: "CAD = blocul cel mai aliniat (CACIB 1,35-1,40; Scotia+CIBC rebound). USD: consensul bull era PRE-NFP, invalidat parțial. EUR neutru. GBP bearish fragil (PMI 48,8). JPY: contradicție CACIB (bull USDJPY 162-163) vs. MUFG (carry vulnerabil). Inbox gol → batch 29.06–03.07." },
