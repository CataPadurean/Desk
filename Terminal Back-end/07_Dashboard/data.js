...
window.DESK_DATA = {
  ...
  summaries: [
    ...
    { k: "2 · Rapoarte bancare", v: "CAD = blocul cel mai aliniat (CACIB 1,35-1,40; Scotia+CIBC rebound). USD: consensul bull era PRE-NFP, invalidat parțial. EUR neutru. GBP bearish fragil (PMI 48,8). JPY: contradicție CACIB (bull USDJPY 162-163) vs. MUFG (carry vulnerabil). Inbox gol → batch 29.06–03.07." },
