...
window.ANALYSIS_DATA = {
 ...
 "comments": {
  ...
  "yields": "10Y US a urcat la 4,50% pe 6.07 (maxim de 2 săpt.) pe revenirea petrolului → temeri de inflație; 2Y US ~4,14%. Spread 2Y USDCAD ~+1,38 (ușor sub +1,43) — încă PRO-USD, criteriul 4 rămâne CONTRA tezei short USDCAD (onest). EURUSD ~−1,60, ușoară restrângere dar încă contra EUR. CAD 2Y 2,76%. NZ 2Y indisponibil în snapshot → criteriul 4 neutru pe NZDUSD. Semnalul agregat: randamentele care urcă = vânt din față pentru tezele anti-USD săptămâna asta."
 },
 "currencies": {
  "USD": {
   "core": true,
